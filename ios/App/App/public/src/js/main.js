...
function setupEventListeners() {
    ...
    // Prevent default touch behavior on canvas area to avoid scrolling
    const canvasArea = document.querySelector('.canvas-area');
    if (canvasArea) {
        canvasArea.addEventListener('touchmove', (e) => {
            // Only prevent if touching canvas, not if scrolling the area
